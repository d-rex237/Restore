...
import { FaStore, FaUsers, FaChartLine, FaArrowRight, FaUpload } from "react-icons/fa";
      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-foreground/70 max-w-2xl mx-auto">
            Join Cameroon's fastest-growing food delivery platform. 
            Reach thousands of hungry customers in your city today.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="p-6 rounded-2xl border border-border bg-card shadow-sm text-center">
            ...
            <p className="text-foreground/60">Get your restaurant in front of 20,000+ active food lovers in your area.</p>
          </div>
          <div className="p-6 rounded-2xl border border-border bg-card shadow-sm text-center">
            <div className="w-14 h-14 bg-primary/10 rounded-full flex items-center justify-center text-primary text-2xl mx-auto mb-4">
              <FaStore />
            ...
            <p className="text-foreground/60">Receive orders instantly through our easy-to-use vendor dashboard.</p>
          </div>
          <div className="p-6 rounded-2xl border border-border bg-card shadow-sm text-center">
            <div className="w-14 h-14 bg-primary/10 rounded-full flex items-center justify-center text-primary text-2xl mx-auto mb-4">
              <FaChartLine />
            ...
            <p className="text-foreground/60">Monitor your revenue daily with real-time analytics and reports.</p>
          </div>
        </div>
        ...
        <div className="max-w-2xl mx-auto bg-card border border-border rounded-2xl shadow-lg p-8 md:p-12">
          ...
          >
            ...
            <div>
              ...
              <input type="text" name="restaurant_name" placeholder="e.g. Mama's Kitchen" className="w-full p-3 rounded-xl border border-border bg-background focus:outline-none focus:ring-2 focus:ring-primary" required />
            </div>
            <div>
            ...
            <div className="grid sm:grid-cols-2 gap-5">
              <div>
                ...
                <input type="email" name="email" placeholder="hello@restaurant.com" className="w-full p-3 rounded-xl border border-border bg-background focus:outline-none focus:ring-2 focus:ring-primary" required />
              </div>
              <div>
            ...
            <div>
              ...
              <input type="text" name="address" placeholder="Bastos, Yaoundé" className="w-full p-3 rounded-xl border border-border bg-background focus:outline-none focus:ring-2 focus:ring-primary" required />
            </div>
