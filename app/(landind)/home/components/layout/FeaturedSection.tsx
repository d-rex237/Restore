...
const categories = [
  ...
  { name: "Main Course", icon: <FaUtensils className="w-6 h-6 text-primary" /> },
  { name: "Desserts", icon: <FaCookieBite className="w-6 h-6 text-primary" /> },
  { name: "Drinks", icon: <FaGlassMartiniAlt className="w-6 h-6 text-primary" /> },
];
...
const dishes = [
  ...
  { id: 2, name: "Eru Soup", price: 3000, rating: 5, image: "/images/fufu-and-eru.webp", description: "Rich, hearty soup made with water leaves, okra, and smoked fish." },
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-10">
        ...
        <div data-aos="fade-up" className="mb-16">
          <div className="text-center mb-8">
            <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-2 tracking-tight">Browse Categories</h2>
        ...
        <div className="mb-16">
          <div className="flex flex-wrap justify-between items-end mb-6">
            ...
            <Link href="/home/menu" className="text-xs font-medium text-primary hover:underline flex items-center gap-1 transition">
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <div className="flex justify-between items-center mt-2 pt-2 border-t border-border/30">
                    <p className="text-[10px] text-foreground/60 line-clamp-1 pr-1">{dish.description}</p>
        ...
        <div data-aos="fade-up" className="mb-16">
          <div className="relative rounded-2xl overflow-hidden min-h-[140px] flex items-center shadow-md border border-border/30 bg-gradient-to-r from-primary to-orange-500">
            ...
            <div className="relative z-20 p-5 md:p-8 text-white w-full flex flex-col md:flex-row justify-between items-center">
              <div>
                <span className="text-[10px] font-bold uppercase tracking-widest text-white/80 mb-1 block">Special Offers</span>
                <h3 className="text-2xl font-bold mb-1">Enjoy 20% OFF</h3>
                <p className="text-white/90 text-xs font-light">Your first order! Use code <span className="font-bold">FLAVOR20</span></p>
              </div>
              <div className="mt-3 md:mt-0 flex items-center gap-3">
                <div className="text-5xl drop-shadow-xl">🍛</div>
                <Link href="/home/menu" className="bg-white text-primary font-bold py-2 px-5 rounded-full hover:bg-gray-100 transition text-xs shadow-md">
                  Order Now
                </Link>
              </div>
            </div>
        ...
        <div className="mb-16">
          <div className="flex justify-between items-end mb-6">
            <div data-aos="fade-right">
              <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-1 tracking-tight">Chef's Special</h2>
            ...
            {chefSpecials.map((dish, index) => (
              ...
              >
                ...
                <div className="p-4 w-full md:w-3/5 flex flex-col justify-center">
                  <div className="flex justify-between items-start mb-1">
                    <h3 className="text-sm font-bold text-foreground">{dish.name}</h3>
        ...
        <div data-aos="fade-up" className="mb-16">
          <div className="text-center mb-8">
            <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-1 tracking-tight">What Our Customers Say</h2>
            <p className="text-sm text-foreground/60">Real reviews from real people</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div data-aos="fade-up" data-aos-delay="100" className={`p-4 rounded-2xl border border-border/30 shadow-sm bg-card/50 hover:bg-card hover:shadow-xl transition`}>
              ...
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 rounded-full bg-gradient-to-r from-primary/20 to-orange-500/20 flex items-center justify-center text-primary text-[10px] font-bold">FM</div>
                <div>
            ...
            <div data-aos="fade-up" data-aos-delay="200" className={`p-4 rounded-2xl border border-border/30 shadow-sm bg-card/50 hover:bg-card hover:shadow-xl transition`}>
              <div className="flex text-yellow-500 text-[10px] mb-2">
                <FaStar /><FaStar /><FaStar /><FaStar /><FaStar />
              </div>
              <p className="text-foreground/80 text-xs italic mb-3 line-clamp-4">
              ...
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 rounded-full bg-gradient-to-r from-primary/20 to-orange-500/20 flex items-center justify-center text-primary text-[10px] font-bold">AC</div>
                <div>
            ...
            <div data-aos="fade-up" data-aos-delay="300" className={`p-4 rounded-2xl border border-border/30 shadow-sm bg-card/50 hover:bg-card hover:shadow-xl transition`}>
              <div className="flex text-yellow-500 text-[10px] mb-2">
                <FaStar /><FaStar /><FaStar /><FaStar /><FaStar />
              </div>
              <p className="text-foreground/80 text-xs italic mb-3 line-clamp-4">
              ...
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 rounded-full bg-gradient-to-r from-primary/20 to-orange-500/20 flex items-center justify-center text-primary text-[10px] font-bold">LJ</div>
                <div>
        ...
        <div data-aos="fade-up" className="relative overflow-hidden rounded-2xl p-8 md:p-10 bg-gradient-to-r from-primary/20 to-orange-500/20 border border-border/30 shadow-sm text-center">
          <div className="relative z-10 max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Link href="#" className="bg-gray-900 text-white px-5 py-2.5 rounded-xl text-xs font-medium hover:bg-gray-800 transition shadow-md">App Store</Link>
              <Link href="#" className="bg-gray-900 text-white px-5 py-2.5 rounded-xl text-xs font-medium hover:bg-gray-800 transition shadow-md">Google Play</Link>
            </div>
          </div>
        </div>
